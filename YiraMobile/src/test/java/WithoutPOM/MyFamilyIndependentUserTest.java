...
public class MyFamilyIndependentUserTest extends AndroidBaseTest{
	...
	public void addNewFamilyMumber() {
		...
		driver.findElement(AppiumBy.accessibilityId("Independent")).click();
		...
		email.click();
		email.sendKeys("nayanika543210@gmail.com");
